...
HD_PWD='D:/GitHub/scr1-sdk_orig/fpga/arty/scr1/arty_scr1/arty_scr1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_scr1_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arty_scr1_top.tcl -notrace
