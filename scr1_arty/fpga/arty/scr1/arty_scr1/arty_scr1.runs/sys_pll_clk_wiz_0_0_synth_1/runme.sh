...
HD_PWD='D:/GitHub/scr1-sdk_orig/fpga/arty/scr1/arty_scr1/arty_scr1.runs/sys_pll_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_pll_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys_pll_clk_wiz_0_0.tcl
