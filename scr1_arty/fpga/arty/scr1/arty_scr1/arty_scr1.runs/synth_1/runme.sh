...
HD_PWD='D:/GitHub/scr1-sdk_orig/fpga/arty/scr1/arty_scr1/arty_scr1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_scr1_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_scr1_top.tcl
