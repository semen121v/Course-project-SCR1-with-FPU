...
#
# Generated by export_simulation on Wed Jul 01 21:44:35 +0300 2020
#
################################################################################
...
'-reset_run' switch to the './FPU_ap_fmul_0_max_dsp_32.sh' script.

./FPU_ap_fmul_0_max_dsp_32.sh -reset_run
...
./FPU_ap_fmul_0_max_dsp_32.sh -noclean_files

For more information on the script, please type './FPU_ap_fmul_0_max_dsp_32.sh -help'.
