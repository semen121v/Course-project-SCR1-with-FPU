...
#set obj_dir         "${proj}.runs/impl_1"
set obj_dir         [get_property directory [get_runs impl_1]]
set script_dir      "../../../scripts/xilinx"
set mem_file        "../../../hex/xilinx_scr1_sram.mem"
...
# Normalization
set script_dir      [file normalize "$proj_dir/$script_dir"]
#set obj_dir         [file normalize "$proj_dir/$obj_dir"]
...
set cmd_file        [file normalize "$script_dir/$cmd_file"]
